...
const NAV_GROUPS: NavGroup[] = [
  {
    group: 'OVERVIEW',
    items: [
      { label: 'Dashboard', href: '/manager/dashboard', icon: <LayoutDashboard size={16} /> },
    ],
  },
  {
    group: 'PROPERTIES',
  ...
  },
  {
    group: 'REPORTS',
    items: [
      { label: 'Reports', href: '/manager/reports', icon: <TrendingUp size={16} /> },
    ],
  },
  {
    group: 'SETTINGS',
    items: [
      { label: 'Settings', href: '/manager/settings', icon: <Settings size={16} /> },
    ],
  },
]
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive
          ? 'text-white bg-white/10 border-l-4 border-[#2d9d5c] pl-3'
...
export function ManagerSidebar() {
  ...
  return (
    <aside
      className="hidden lg:flex fixed top-0 left-0 h-screen w-60 flex-col z-30"
    ...
    >
      ...
      <div className="shrink-0 border-t border-white/10 p-3">
        ...
        <div className="flex items-center justify-between">
          <span className="inline-flex items-center rounded-full bg-[#2d9d5c]/20 px-2 py-0.5 text-[10px] font-medium text-[#2d9d5c]">
            Manager
          </span>
          <button
